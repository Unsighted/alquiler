...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/imask/6.0.3/imask.js"></script>
...
<body>
 ...
 <div class="payment-title">
        <button class="btn btn-info"><h2>Información de Pago</h2></button>
    </div>
    <div class="container preload">
            ...
            <div class="front">
                ...
                <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">Unsighted</text>
            ...
            <div class="back">
                <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                        ...
                        <text transform="matrix(1 0 0 1 621.999 227.2734)" id="svgsecurity" class="st6 st7">cvc</text>
                        <g class="st8">
                            <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">security code</text>
                        </g>
                        <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5" />
                        <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5" />
                        <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">Unsighted</text>
                    </g>
                </svg>
            </div>
        </div>
        ...
        <!-- <form action="{{url('subscribe')}}" method="post" id="payment-form" onsubmit="validar();">
            <script
            src="https://checkout.stripe.com/checkout.js" class="stripe-button"
            data-key= "{{config('services.stripe.key')}}"
            data-amount="1000"
            data-name="Motoempresa"
        ...
        <div class="form-container">
            ...
            <div class="field-container">
                ...
                <!-- input random para tarjeta, solo para probar random o ver array js para ver número de tarjeta e insertar manual

                <label for="card-element">Número de tarjeta</label><!--span id="generatecard">generate random</span-->
               
               <!-- descomentar para el pago stripe -->

                <!-- <input id="cardnumber"  type="text" pattern="[0-9]*" inputmode="numeric">
                <div id="card-element"  type="text" pattern="[0-9]*" inputmode="numeric"> -->
            ...
            <div id="card-errors" role="alert"></div>
                ...
                <div>
                    <button class="btn btn-success pointer">Realizar pago</button>
                </div>
            </div>
        </div>
      </form> -->
...
name.addEventListener('input', function () {
    if (name.value.length == 0) {
        document.getElementById('svgname').innerHTML = 'Unsighted';
        document.getElementById('svgnameback').innerHTML = 'Unsighted';
    } else {
...
// });
    ...
    var stripe = Stripe('pk_test_kwxsRKbPjag71wSqNv8eeRPU00jCIbA68t');
